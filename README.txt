...
It also requires Biopython, Numpy, Matplotlib and Plotly. Please check that they are installed.

If you want to install this program, you can do it:
...
EXAMPLES:
	correlate -i1 tfg-b.fa -o tfg-b_output

	correlate -i1 tfg-b.fa -i2 tfg-b3.fa -p plotly

	correlate -mfa1 multifasta1.mfa -p plotly -f 0.4

	correlate -mfa1 multifasta1.mfa -mfa2 multifasta2.mfa -o output_name -f 0.04



USAGE:

correlate [-h] [-i1 INFILE1] [-i2 INFILE2] [-mfa1 MULTIFASTA_1]
